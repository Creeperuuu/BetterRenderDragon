...
extern bgfx::RayTracingFeatureConfiguration *gRayTracingFeatureConfiguration;
void DrawRayTracingDebugWindow(bool *p_open) {
  if (!ImGui::Begin("RayTracing Debug", p_open)) {
    ImGui::End();
    return;
  }
  auto cfg = gRayTracingFeatureConfiguration->mBgfxRayTracingConfiguration;
  ...
  ImGui::InputFloat("HeightMap Pixel Edge Width", &cfg.mHeightMapPixelEdgeWidth,
                    0.01f, 0.1f);
  ...
  ImGui::InputFloat("Water Henyey Greenstein G", &cfg.mWaterHenyeyGreensteinG,
                    0.01f, 0.1f);
  ImGui::InputFloat("Fog Density Multiplier", &cfg.mFogDensityMultiplier, 0.01f,
                    0.1f);
  ...
  ImGui::Checkbox("Probability Based Raycasts", &cfg.mProbabilityBasedRaycasts);
  ...
  ImGui::InputFloat("SVGF Diffuse Alpha Moments", &cfg.mSVGFDiffuseAlphaMoments,
                    0.01f, 0.1f);
  ImGui::InputFloat("SVGF Diffuse Phi Luminance", &cfg.mSVGFDiffusePhiLuminance,
                    0.01f, 0.1f);
  ...
  ImGui::InputFloat("Tone Mapping Curve Shift", &cfg.mToneMappingCurveShift,
                    0.01f, 0.1f);
  ImGui::InputFloat("Tone Mapping Dynamic Range", &cfg.mToneMappingDynamicRange,
                    0.01f, 0.1f);
  ...
  ImGui::End();
  gRayTracingFeatureConfiguration->mBgfxRayTracingConfiguration = cfg;
}